...
function Footer() {
  ...
  return (
    <div className="footer dark:bg-transparent  pt-20">
        ...
        <div className="footer-inner dark:bg-transparent">
          <div className="join-us block md:flex   gap-2 items-center border rounded-xl p-5 md:p-10 py-8 md:py-16 ">
            <div className="join-us-text  w-[100%] md:w-[60%]">
              <h2 className="md:text-[53px] text-[25px] font-black">
                You can also be among this team :)
              </h2>
              <p className="md:text-[20px] mt-2 text-[15px]  font-medium">
            ...
            <div className="join-us-jobs mt-5 md:mt-0">
              <div className="joib-own w-[100%] flex items-center gap-4 mt-2">
                ...
                <p className="md:text-[23px] text-[18px] font-bold">
              ...
              <div className="joib-own flex items-center gap-4 mt-2">
                ...
                <p className="tmd:text-[23px] text-[18px] font-bold">
          ...
          <div className="footer-nav flex justify-between mt-10">
            <button
              onClick={handleTop}
              className="go-top border rounded-full p-3 hidden md:block  dark:bg-transparent ml-auto"
            >
              <svg
      ...
      <div className="media-wrap mx-auto block md:flex  xl:container px-2 md:px-10 gap-20 md:gap-20 items-center">
        <div className="soshile-media w-[80%] mx-auto text-center flex flex-wrap md:flex items-center gap-5 mt-10">
        ...
        <div className="contact block md:w-[100%] flex-wrap px-5 items-center md:flex gap-12 mt-10">
          <Link to="" className="flex items-center gap-2 hover:text-[#FFB534]">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="30"
              viewBox="0 0 24 24"
          ...
          <Link
            to="/"
            className="flex gap-2 items-center hover:text-[#FFB534] mt-5 md:mt-0"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="30"
